...
const Explore = () => {
  ...
  return (
    <div className="bg-slate-50 min-h-screen">
      ...
      <div className="ga-container mt-20 py-8 flex gap-8">
        ...
        <aside className="hidden lg:block w-56 shrink-0 space-y-6">
          ...
          <div className="p-4 bg-blue-600 rounded-xl text-white shadow-lg shadow-blue-200">
            <h4 className="text-xs font-black mb-2 uppercase tracking-tight">
              Need Expert Help?
            </h4>
            <p className="text-[9px] font-medium leading-relaxed opacity-90 mb-3">
